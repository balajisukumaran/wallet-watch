...
public class Md5LambdaFunctionHandler implements RequestHandler<Map<String, String>, Map<String, Object>> {
    ...
    public Map<String, Object> handleRequest(Map<String, String> event, Context context) {
        ...
        try {
            ...
            String hashedValue = HashingService.hashMD5(valueToHash);

            TreeMap<String, Object> response = new TreeMap<>();
            response.put("banner", "B00948977");
            response.put("result", hashedValue);
            response.put("arn", "arn:aws:lambda:us-east-1:590183799919:function:encryptMd5");
            response.put("action", "md5");
            ...
            HttpRequest postRequest = HttpRequest.newBuilder().uri(URI.create(url)).header("Content-Type", "application/json").POST(HttpRequest.BodyPublishers.ofString(jsonBody)).build();
